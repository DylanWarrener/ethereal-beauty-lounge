...
const lightTheme: ThemeDefinition = {
  ...
  colors: {
    ...
    'section-2-title': primaryColours['primary-tone-1'],
    'section-2-subtitle': blackColours['black-tint-3'],
    ...
    'section-3': secondaryColours['secondary-tint-3'],
    'section-3-title': accentColours['accent-tone-1'],
